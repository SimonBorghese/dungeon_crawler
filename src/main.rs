...
impl App {
    ...
    unsafe fn create(window: &sdl2::video::Window) -> Result<Self> {
        ...
        create_command_poll(&instance, &device, &mut data)?;
    ...
    unsafe fn render(&mut self, window: &sdl2::video::Window) -> Result<()> {
        ...
        let present_semaphores = &[self.data.image_available_semaphore, self.data.render_finished_semaphore];
    ...
    unsafe fn destroy(&mut self) {
        ...
        self.device.destroy_command_pool(self.data.command_poll, None);
...
unsafe fn create_command_buffers(device: &Device, data: &mut AppData) -> Result<()>{
    let allocate_info = vk::CommandBufferAllocateInfo::builder()
        .command_pool(data.command_poll)
...
unsafe fn create_command_poll(
    ...
    data.command_poll = device.create_command_pool(&info, None)?;
